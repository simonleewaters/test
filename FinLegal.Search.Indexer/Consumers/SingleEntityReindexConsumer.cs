...
public class SingleEntityReindexConsumer(ILogger<SingleEntityReindexConsumer> logger, IContactSearchIndexer contactSearchIndexer) : IConsumer<SingleEntityReindexRequest>
{
    public async Task Consume(ConsumeContext<SingleEntityReindexRequest> context)
    {
